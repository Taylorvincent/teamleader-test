...
In the [example-orders](./test-copy/example-orders/) directory, you can find a couple of example orders.
...
In the [data](./test-copy/data/) directory, you can find source files for customer data and product data, in case you need it.
You can assume these are in the format of the real external API.
